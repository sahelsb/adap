...
export class StringName extends AbstractName {
    ...
    public setComponent(i: number, c: string): Name {
        ...
        const result = new StringName(newNameString, this.delimiter);
        
        MethodFailedException.assert(
            result.getComponent(i) === c,
            "Postcondition not met: Component was not set correctly in new object."
        );
        MethodFailedException.assert(
            result.getNoComponents() === this.noComponents,
    ...
    public insert(i: number, c: string): Name {
        ...
        MethodFailedException.assert(
            result.getNoComponents() === this.noComponents + 1,
